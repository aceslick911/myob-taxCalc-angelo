...
const au_fy2020_2021 = () => {
    const taxTablesFromFile = helpers_1.readTaxTableFromFile("tax_calculators/au/2020_2021/tax_table.json");
    const data_sources = {
    ...
    const BracketTaxCalculator = (annual_income, bracket) => {
        ...
        if (bracket_applicable_to_annual_income === false) {
            ...
            const tax_payable_for_bracket = dollars_over_threshold *
    ...
    const AnnualIncomeTaxCalculator = (annual_income) => {
        ...
        const total_tax_for_annual_income = taxAmountPaidByBracket.reduce((total, bracket_tax) => {
