...
exports.income_calculators = {
    au: {
        fy2020_2021: _2020_2021_1.au_fy2020_2021()
    }
};
const paySlipForEmployee = (employee, income_calculator) => {
    ...
    const gross_monthly_income = helpers_1.transform.annual_amnt_to_monthly_amnt({
        annual_amount: employee.annual_income
    });
    const monthly_income_tax = helpers_1.transform.annual_amnt_to_monthly_amnt({
